...
function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 backdrop-blur-xs relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="flex space-x-4">
                  ...
                  {isLoaded && isSignedIn && (
                    <>
                      ...
                      <Link href="/profile" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">
                        Perfil
                      </Link>
                      <button
                        className="bg-purple-600/30 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-purple-600 hover:text-white cursor-pointer"
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              <button type="button" className="relative rounded-full p-1 text-gray-400 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500 mr-3">
      ...
      {isLoaded && isSignedIn && isChatOpen && (
        <NotesProvider>
          <ChatModal
            isOpen={isChatOpen}
