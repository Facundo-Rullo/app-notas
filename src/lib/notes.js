...
export default async function Page() {
  ...
  {
    id: "7",
    title: "Spreed Operator",
    category_id: 4,
    content: "El spreed operator en JavaScript permite expandir elementos de un array o propiedades de un objeto en otro array u objeto. Es util para crear copias de arrays u objetos con modificaciones menores",
    createdAt: "2026-01-06",
    ejemplo: `
const obj1 = { a: 1, b:2 }
const obj1 = { ...obj1, c:3 } //{a: 1, b:2, c:3 }
